...
contract StarNotary is ERC721Full {
    ...
    // Adds name and symbol properties using the "full" version of EERC721
    constructor() public ERC721Full("Awesome Starz", "STZ") {}
    ...
    {
        //Returns the Star saved in tokenIdToStarInfo mapping
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            ...
            "To transfer a star, you need to be the star owner"
        );
